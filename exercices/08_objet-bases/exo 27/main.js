...
document.addEventListener("DOMContentLoaded", () => {
  ...
  */
  ...
  const myInput1 = document.querySelector("input#mon-input");
  ...
  monButton.addEventListener("click", (event) => {
    ...
    if (monUL) {
      ...
      nouvelLI.textContent = myInput1.value.trim();
...
const maFonction = () => {
  ...
  nouvelLI.value = myInput1.value
};


// let myInput1 = document.querySelector("input#mon-input");

// document.querySelector("#btn-ajout").addEventListener("click", () => {
//   let prenom = document.querySelector("input#prenom").value;

//   let nouveauPrenom = document.createElement("li");
//   nouveauPrenom.textContent = prenom;

//   if (prenom === "") {
//       const nouveauPrenom = document.createElement("li");
//       nouveauPrenom.textContent = prenom;

//       const listePrenoms = document.querySelector("#liste-prenoms");
//       listePrenoms.appendChild(nouveauPrenom);
//       inputPrenom.value = "";
//   }
// })