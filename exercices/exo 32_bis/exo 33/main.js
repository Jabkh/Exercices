...
document.addEventListener("DOMContentLoaded", () => {
  ...
  chats.forEach((p, i) => {
    ...
    newTDElement.textContent = p;
    // newLIElement.className = "vos classes"
    // newLIElement.classList.add("nouvelle-classe")
    newTDElement.setAttribute("data-exo-cat-name", p);
    newTDElement.addEventListener("click", () => {
      newTDElement.remove();
    });

    document.getElementById("cat-display")?.appendChild(newTDElement);
